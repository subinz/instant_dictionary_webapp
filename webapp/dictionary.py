...
class Dictionary(page.Page):
    ...
    def serve(cls, request):
        ...
        input_box = jp.Input(a=input_div, placeholder="Type in a new word here...", output_div=output_div,
                             classes="m-2 bg-grey-100 border-2 border-ger=grey-200 rounded w-64 focus:bg-white "
